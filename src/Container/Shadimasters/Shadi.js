...
<div className="container-fluid px-lg-5 px-3 mb-4" id="whySmVendor">
            <div className="row px-lg-5 px-3 ">
                ...
                <div className="col-lg-12 mx-auto px-lg-5 px-3 text-center d-flex flex-column">
                    ...
                    <p className="text-muteds lh-lg flex-grow-1"><span className="logotext">ShadiMasters</span> ranks very highly
                        with the major search engines
                        for event-related search terms. The vast majority of our
                        visitors come as a result of searching for a place or a service for their event. Try it out!
                    </p>

                    <p className="text-muteds lh-lg flex-grow-1">Unlike some other Wedding marketplace, <span className="logotext">ShadiMasters</span> provides
                        you the opportunity to connect with potential clients in
                        multiple ways to ensure profitable results. It also offers a digital place to showcase your
                        services and products
                        effectively throughout PAN India. User- friendly and highly effective technologies enable ease
                        to operate your business
                        effortlessly. There are many more to come soon till then….. Stay tuned !!
                    </p>
                    <p className="text-muteds lh-lg flex-grow-1">Get Noticed to a whole new world of End users who are on a
